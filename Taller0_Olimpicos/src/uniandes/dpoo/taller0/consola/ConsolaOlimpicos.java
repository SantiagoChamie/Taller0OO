...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país al que pertenece un atleta");
	...
	/**
	 * Ejecuta la opcion para consultar la nacionalidad de un atleta
	 */
	private void ejecutarPaisDeAtleta() 
	{
		...
		System.out.println("Pais que representa el atleta: " + pais);
	}
